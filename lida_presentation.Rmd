---
title: "Getting 'on the case' with population data"
author: "Jon Minton"
date: "26 June 2018"
subtitle: "Using Lexis surfaces to see more data, better"
...
## Fez: A metaphor for variable-based quantitative research

<iframe width="400" height="300" src="https://upload.wikimedia.org/wikipedia/commons/transcoded/4/47/FEZ_trial_gameplay_HD.webm/FEZ_trial_gameplay_HD.webm.360p.webm" frameborder="0" allowfullscreen></iframe>
...
- Partition into Age, Period and Cohort (APC) Effects
...
knitr::include_graphics("presentation images/smoothed_for_wws_blog.png")
...
## Example of Naive over-flexible models

```{r out.width= "96%", echo = F}
knitr::include_graphics("presentation images/alt_naive_models.PNG")
...
- Your thoughts about population processes should not be limited by what you can easily express in a statistical model
- Don't think in slices, think in structures
